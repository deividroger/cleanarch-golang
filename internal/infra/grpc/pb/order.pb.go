...
func (x *ListOrderInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListOrderInput) ProtoMessage() {}

func (x *ListOrderInput) ProtoReflect() protoreflect.Message {
	mi := &file_protofiles_order_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListOrderInput.ProtoReflect.Descriptor instead.
func (*ListOrderInput) Descriptor() ([]byte, []int) {
...
var file_protofiles_order_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x10, 0x0a, 0x0e,
	0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x22, 0x36,
	...
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0x87, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x12, 0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x4c,
...
var file_protofiles_order_proto_goTypes = []interface{}{
	...
	(*ListOrderInput)(nil),      // 3: pb.ListOrderInput
...
var file_protofiles_order_proto_depIdxs = []int32{
	...
	3, // 2: pb.OrderService.ListOrders:input_type -> pb.ListOrderInput
